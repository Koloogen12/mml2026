...
export const WidgetModal: FC<WidgetModalProps> = ({
  ...
  // Lock page scroll while the widget is open so horizontal/vertical
  // swipes inside our scrollable lists (product carousel, size/vendor
  // sheets) don't bubble through to the storefront page beneath.
  useEffect(() => {
    if (!isOpen) return;
    const prevOverflow = document.body.style.overflow;
    const prevPaddingRight = document.body.style.paddingRight;
    // Compensate for the scrollbar disappearing so the store layout
    // doesn't shift horizontally when we hide overflow.
