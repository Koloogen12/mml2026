...
import { IChatMessage, MotionChatMessage } from '@/fsd/shared/ui/ChatMessage/ChatMessage';
...
export default function Chat({ content, stylization, className, onClick }: IProps) {
  return (
        ...
        >
          {content.chat &&
            content.chat.map((message) => (
              <MotionChatMessage message={message} key={message.text} variants={chatVariants} />
            ))}
