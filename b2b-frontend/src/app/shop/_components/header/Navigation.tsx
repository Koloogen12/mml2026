...
const Navigation = () => {
  ...
  const topCategories = [
    { name: 'ДЛЯ НЕЕ', href: '/shop', active: currentPath === '/shop' },
    { name: 'ДЛЯ НЕГО', href: '/shop/category/men', active: currentPath === '/shop/category/men' },
    { name: 'ДЛЯ ДЕТЕЙ', href: '/shop/category/kids', active: currentPath === '/shop/category/kids' },
  ];

  const navItems = [
    { name: 'Новинки', href: '/shop/category/new' },
    { name: 'Платья', href: '/shop/category/dresses' },
    { name: 'Верх', href: '/shop/category/tops' },
    { name: 'Низ', href: '/shop/category/bottoms' },
    { name: 'Верхняя одежда', href: '/shop/category/outerwear' },
    { name: 'Свадебная коллекция', href: '/shop/category/wedding' },
  ];

  const popularSearches = ['Платья', 'Свадебные платья', 'Кашемир', 'Пальто', 'Сумки', 'Обувь'];
      ...
      >
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2">
          <Link href="/shop" className="block">
            <img src="/shop/makemeelook-logo.png" alt="MakeMeLook" className="h-5 w-auto" />
          </Link>
        </div>
      ...
      <div className="flex items-center h-11 border-b border-border">
        ...
        {!isMobile && (
          ...
          >
            ...
            <span className="text-sm font-light border-b border-border pb-0.5" style={{ minWidth: 140 }}>
              Что вы ищете?
            </span>
          </div>
        )}
