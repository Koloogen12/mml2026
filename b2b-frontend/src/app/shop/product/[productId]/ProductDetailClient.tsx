...
import ProductCard from '../../_components/content/ProductCard';
import {
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-20 px-6 text-center">
          ...
          <Link href="/shop" className="text-sm underline mt-4 inline-block">На главную</Link>
        </main>
        <Footer />
      </div>
    );
          ...
          <div className="lg:hidden mb-6">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbLink asChild><Link href={categoryPath}>{product.category ?? 'Одежда'}</Link></BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator />
                <BreadcrumbItem>
