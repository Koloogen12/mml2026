...
type UpdateProjectTryonProviderRequest struct {
	TryonProvider string `json:"tryon_provider" validate:"required,oneof=cometapi-gptimage cometapi-gemini gemini fal-nb1 fal-nb2"`
}
...
type ProjectResponse struct {
	...
	TryonProvider       string   `json:"tryon_provider"`
