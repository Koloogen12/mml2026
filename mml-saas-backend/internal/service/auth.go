...
var (
	...
	// ErrProjectPaused is returned by widget endpoints when the owning
	// project's status is 'paused'. Mapped to 403 by the handler so the
	// loader silently hides the widget on the customer's site.
