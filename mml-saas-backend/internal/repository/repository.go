...
type Repositories struct {
	...
	ConsentLog        *ConsentLogRepository
	WaitlistSignup    *WaitlistSignupRepository
...
func newRepos(db *gorm.DB) *Repositories {
	return &Repositories{
		...
		SyncHistory:       newSyncHistoryRepository(db),
		ConsentLog:        newConsentLogRepository(db),
		WaitlistSignup:    newWaitlistSignupRepository(db),
