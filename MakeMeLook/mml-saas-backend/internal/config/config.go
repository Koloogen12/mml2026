...
type Config struct {
	...
	CometAPIURL        string
	CometAPIKey        string
	CometAPITryOnModel string
	CometAPITimeoutSec int
	CometMaxRetries    int
...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		CometAPIURL:        getEnv("COMET_API_URL", "https://api.cometapi.com/v1"),
		CometAPIKey:        getEnv("COMET_API_KEY", ""),
		CometAPITryOnModel: getEnv("COMET_API_TRYON_MODEL", "gemini-3-pro-image-preview"),
		CometAPITimeoutSec: getEnvInt("COMET_API_TIMEOUT_SEC", 300),
		CometMaxRetries:    getEnvInt("COMET_MAX_RETRIES", 3),
