...
export const ru: Translations = {
  ...
  'common.male': 'Мужской',
  'common.all': 'Все',
  'common.poweredBy': 'Работает на MakeMeLook',
  ...
  // Intro
  'intro.heading': 'Примерьте на себе',
  'intro.description': 'Загрузите фото, укажите параметры — и подбирайте вещи и целые образы в одно касание прямо на себе.',
  'intro.start': 'Начать',
  ...
  'photoUpload.descPrefix': 'Для лучшего результата следуйте нашим',
  ...
  // BasicParameters
  'basicParams.heading': 'Ваши параметры',
  'basicParams.subheading': 'Укажите рост, вес и пол — это поможет точно подобрать размер',
  ...
  // PrivacyPolicy
  'privacy.heading': 'Ваши фото — только для вас',
  'privacy.subheading': '',
  'privacy.description': 'Мы не передаём и не продаём данные третьим лицам. Всё используется исключительно для работы виджета MakeMeLook.',
